...
export default function InventoryDetail({ id }: { id: string }) {
  ...
  return (
    <div className="bg-background px-6 py-7 rounded-md">
      <InventoryForm formType="EDIT" initialValues={initialForm} onSubmit={onSubmit} initialSelectedCategory={inventory.kategori} initialSelectedUnit={inventory.satuan} />
    </div>
  );
}
