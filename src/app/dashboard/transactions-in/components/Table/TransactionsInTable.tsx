...
const INITIAL_VISIBLE_COLUMNS = ["id", "nomorLot", "barang", "hargaTotal", "tanggal", "actions"];
...
export default function TransactionsInTable({ transactions }: TransactionsTableProps) {
  ...
  const renderCell = useCallback(
    (transaction: TransactionIn, columnKey: React.Key) => {
      const cellValue: cellValueType = transaction[columnKey as keyof TransactionIn];
              ...
              <Dropdown>
                ...
                <DropdownMenu>
                  <DropdownItem
                    ...
                    as={Link}
                    href={`/dashboard/inventories/edit/${transaction.id}`}
      ...
      <div className="flex flex-col gap-4 mb-4">
        <div className="flex flex-col lg:flex-row justify-between gap-3 items-center">
          ...
          <div className="flex-1 flex justify-end gap-3">
            ...
            <Button as={Link} href="/dashboard/transactions-in/add" color="primary" className="font-semibold w-fit" startContent={<IoIosAdd size={20} />}>
              Transaksi Masuk
            </Button>
